...
export default function DesprePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Despre DroneAgricol.ro</h1>

      <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
        <p className="text-lg leading-relaxed">
          <strong>DroneAgricol.ro</strong> este primul director complet de operatori de drone agricole din România și Moldova. Misiunea noastră este simplă: să conectăm fermierii cu operatorii de drone agricole verificați din zona lor, în cel mai rapid mod posibil.
        </p>
        ...
        <p className="leading-relaxed">
          Am construit DroneAgricol.ro pentru a umple acest gol: un director structurat, cu profiluri detaliate, prețuri orientative și posibilitatea de a contacta direct operatorul.
        </p>
        ...
        <p className="leading-relaxed">
          Listarea în DroneAgricol.ro este și va rămâne <strong>complet gratuită</strong> pentru toți operatorii de drone agricole din România și Moldova. Nu percepem comisioane, nu există versiuni premium ascunse. Putem oferi în viitor opțiuni de promovare suplimentară, dar listarea de bază va fi mereu gratuită.
        </p>
