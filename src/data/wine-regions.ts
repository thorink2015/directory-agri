...
export const wineRegions: WineRegion[] = [
  ...
  },
  {
    ...
    droneServiceAdvantage:
      'Podgoriile Murfatlar au loturi mari și uniform, ideale pentru pulverizare eficientă cu drona. Clima uscată sporadic necesită intervenții precise pentru mana viței — drona asigură acoperire 100%.',
  },
  {
    slug: 'cotnari',
    name: 'Cotnari',
